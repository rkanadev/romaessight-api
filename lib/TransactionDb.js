...
var genesisTXID = '000005dab0c470667d1c87d42e5fd7d805ccfc2fa950215c14610eea4eb5c882'; //Roma-E-Solidus
var CONCURRENCY = 5;
...
var bitcore = require('romaescore'),
...
var encodedData = require('soop').load('romaescore/util/EncodedData', {
  base58: base58
});
var versionedData = require('soop').load('romaescore/util/VersionedData', {
  parent: encodedData
});

var Address = require('soop').load('romaescore/lib/Address', {
