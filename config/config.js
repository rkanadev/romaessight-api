...
var home = process.env.INSIGHT_DB || (getUserHome() + '/.insight-romaes');
...
if (!dataDir) {
  if (isWin) dataDir = '%APPDATA%\\Roma-E-Solidus\\';
  if (isMac) dataDir = process.env.HOME + '/Library/Application Support/Roma-E-Solidus/';
  if (isLinux) dataDir = process.env.HOME + '/.Roma-E-Solidus/';
}
